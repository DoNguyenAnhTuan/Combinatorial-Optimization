...
value_at_2_4 = RM_numeric[col_to_delete][row_to_delete]
# Đổi giá trị tại vị trí (2, 4) thành 'x'
RM_numeric[col_to_delete][row_to_delete] = np.nan
print(RM_numeric)
# In giá trị tại vị trí 2, 4
# print(f"Giá trị tại vị trí (2, 4): {value_at_2_4}")

# In hàng và cột cần xóa
print(f"\nXóa hàng: {row_labels[row_to_delete]} và cột: {row_labels[col_to_delete]}")
